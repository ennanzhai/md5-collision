...
void md5_compress(uint32 ihv[], const uint32 block[])
{
	...
	MD5_STEP(FF, a, b, c, d, block[0], 0xd76aa478, 7);         // Func F to make the compress
	...
	MD5_STEP(GG, a, b, c, d, block[1], 0xf61e2562, 5);          // Func G to make the compress
	...
	MD5_STEP(HH, a, b, c, d, block[5], 0xfffa3942, 4);             // Func H to make the compress
	...
	MD5_STEP(II, a, b, c, d, block[0], 0xf4292244, 6);              // Func I to make the compress
